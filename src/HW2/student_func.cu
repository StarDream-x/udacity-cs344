                   ...
                   const float* const filter, const int filterWidth)
{
  ...
  size_t nid = idx_x * numCols + idx_y;
  float newValue = 0;
                      ...
                      unsigned char* const blueChannel)
{
  ...
  size_t idx_y = blockIdx.y * blockDim.y + threadIdx.y;
  if(idx_x >= numRows || idx_y >= numCols) return;
  uchar4 rgbValue = inputImageRGBA[idx_x * numCols + idx_y];
  redChannel[idx_x * numCols + idx_y] = rgbValue.x;
  greenChannel[idx_x * numCols + idx_y] = rgbValue.y;
  blueChannel[idx_x * numCols + idx_y] = rgbValue.z;
}
                                ...
                                const float* const h_filter, const size_t filterWidth)
{
  ...
  checkCudaErrors(cudaMalloc((void **)&d_filter, filterSize));
                        ...
                        const int filterWidth)
{
  ...
  size_t gridSizeX = numRows/blockWidth + 1;
  size_t gridSizeY = numCols/blockWidth + 1;
